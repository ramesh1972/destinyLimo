...
export class UserExamAnswersComponent {
  ...
  setRadioValue(value: string): void {
    ...
    if (value === 'Correct') {
      this.filteredUserAnswers = this.userAnswers.filter((ua: any) => ua.is_correctly_answered === true);
    }
    else if (value === 'Incorrect') {
      this.filteredUserAnswers = this.userAnswers.filter((ua: any) => ua.is_correctly_answered === false);
    }
  }
